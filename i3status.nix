{ fetchurl, lib, stdenv, libconfuse, yajl, libpulseaudio, libnl, pkg-config, asciidoc, xmlto, docbook_xml_dtd_45, docbook_xsl, alsaLib }:
...
stdenv.mkDerivation rec {
  ...
  buildInputs = [ libconfuse yajl libpulseaudio libnl alsaLib ];
